...
public:
    ...
    /**
     * @brief Constructor with RGB (& A) values 
     * 
    ...
    /**
     * @brief Convert the pixel to greyscale using the luminance formula
     * 
     * Uses the formula Y = 0.2126R + 0.7152G + 0.0722B as specified in the project requirements
     * 
     * @return Pixel A new greyscale pixel where R = G = B = Y
     */
    Pixel toGreyscale() const;
