...
namespace adv_prog_cw {
	...
	Matrix_06008146<fT>::Matrix_06008146()
		: rows(0), cols(0)
	{
	}
	...
	// ---------------------------------------
	template<typename fT>
	Matrix_06008146<fT>& Matrix_06008146<fT>::operator=(const Matrix_06008146<fT>& mat)
	{
		if (&mat != this) {
			rows = mat.rows;
			cols = mat.cols;
	...
	template<typename fT>
	Matrix_06008146<fT>& Matrix_06008146<fT>::operator=(fT val)
	{
		for (size_t i = 0U; i < rows; i++)
	...
	// ---------------------------------------
	template<typename fT>
	Matrix_06008146<fT>::Matrix_06008146(const Matrix_06008146<fT>& mat)
	{
		*this = mat;
	}
	...
	// ---------------------------------------
	template<typename fT>
	Matrix_06008146<fT>::Matrix_06008146(size_t m, size_t n, fT val)
		: rows(m), cols(n)
	{
		data.resize(rows, vector<fT>(cols));
...
#endif
		Matrix_06008146<fT>  temp(a.Rows(), b.Cols());
	...
	// ---------------------------------------
	template<typename fT>
	vector<fT>  operator*(const Matrix_06008146<fT>& mat, const vector<fT>& vec)
	{
   ...
   // ---------------------------------------
	template<typename fT>
	Matrix_06008146<fT>  operator*(const vector<fT>& vec, const Matrix_06008146<fT>& mat)
	{
		...
		Matrix_06008146<fT>  temp(vec.size(), mat.Cols());
   ...
   // ---------------------------------------------
	template<typename fT>
	void Matrix_06008146<fT>::Resize(size_t m, size_t n)
	{
	...
	// ---------------------------------------------
	template<typename fT>
	void Matrix_06008146<fT>::Identity()
	{
		for (size_t i = 0U; i < rows; i++)
			for (size_t j = 0U; j < cols; j++)
	...
	// ---------------------------------------------
	template<typename fT>
	void Matrix_06008146<fT>::Transposed(Matrix_06008146& M) const
	{
		M.Resize(cols, rows);
	...
	// ---------------------------------------
	template<typename fT>
	void Matrix_06008146<fT>::Out(long digits) const
	{
		std::streamsize  prec;
   ...
   // ------------------------------------------------------------------------------
	...
	template class Matrix_06008146<double>;

	template Matrix_06008146<double>  operator+(
		const Matrix_06008146<double>& a,
		const Matrix_06008146<double>& b);
	...
	template Matrix_06008146<double>  operator*(
		...
		const Matrix_06008146<double>& b);
	template
		vector<double>  operator*(const Matrix_06008146<double>& mat,
			const vector<double>& vec);

	// extra operators
	template Matrix_06008146<double64>
		operator*(const vector<double64>& vec, const Matrix_06008146<double64>& mat);
}