 ...
 * @brief Tests for the PrewittFilter class
 * @group [Euler]
 * 
 * Group members:
...
/**
 * @brief Run tests for the PrewittFilter class
 *
 * This function tests the basic functionality of the PrewittFilter,
...
void runPrewittFilterTests() {
    ...
    CHECK(filter.getName() == "Prewitt", "PrewittFilter constructor should set correct name");
    ...
    // Apply the Prewitt filter to detect edges
