 ...
 * 
 * DataContainer provides a common interface for 2D images and 3D volumes,
 * with shared functionality for handling data coordinates and dimensions.
...
private:
     ...
     * @throws std::invalid_argument If the dimension is not positive
     */
...
public:
     ...
     * @param parameters Optional parameters for the filter
